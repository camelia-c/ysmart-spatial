...
boolean_literal
	...
	;
spatial_literal
	:	k_geometry LPAREN quoted_string  RPAREN
	;
...
k_geometry  : r='ST_GEOMETRY' { $r->setType($r, T_RESERVED); }  ;
...
keyword
    ...
    | 'XML'        
    | 'XMLDATA'     
    | 'ST_AREA'                         | 'ST_PERIMETER'       | 'ST_LENGTH'            
    | 'ST_CENTROID'                  | 'ST_BOUNDARY'       
    | 'ST_INTERSECTION'           | 'ST_UNION'               | 'ST_DIFFERENCE'
    | 'ST_DISTANCE'                   | 'ST_CONTAINS'        |  'ST_CROSSES'
