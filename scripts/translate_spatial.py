...
def genXMLTree(queryFile, tmpFilePath):
    ...
    #subprocess.check_call(EXEC_DIR + '/YSmartFront.exe ' +  queryFile + ' > ' + tmpFilePath, shell=True) #was in YSmart
    subprocess.check_call(EXEC_DIR + '/YSmartSpatialFront.exe ' +  queryFile + ' > ' + tmpFilePath, shell=True)
