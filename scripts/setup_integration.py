...
def setup_integrate_install():
    ...
    print 'g++  -o libReducerRESQUE.so -shared -Wl,-soname,libReducerRESQUE.so -I/java/include -I/usr/lib/jvm/jdk1.6.0/include/linux -I /usr/lib/jvm/jdk1.6.0/include/  -I'+CURRENT_DIR + '/' +BOOST_DIR+'   '+os.getcwd()+'/ReducerRESQUE.cpp -static -lc' 
    print '--------------------------------------------------------------------'    
    subprocess.check_call(['g++', '-olibReducerRESQUE.so', '-shared','-Wl,-soname,libReducerRESQUE.so','-I/java/include','-I/usr/lib/jvm/jdk1.6.0/include/linux','-I/usr/lib/jvm/jdk1.6.0/include/','-I'+CURRENT_DIR + '/' +BOOST_DIR,''+os.getcwd()+'/ReducerRESQUE.cpp','-static','-lc'])  
...
def print_usage():
    print 'usage: ./setup_integration.py install/uninstall'
